...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_bustCache_ShopcarContainer_vue__ = __webpack_require__(316);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_749f5d66_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_bustCache_ShopcarContainer_vue__ = __webpack_require__(321);
var disposed = false
...
/* scopeId */
var __vue_scopeId__ = "data-v-749f5d66"
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_749f5d66_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_bustCache_ShopcarContainer_vue__["a" /* default */],
...
if (true) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-749f5d66", Component.options)
  } else {
    hotAPI.reload("data-v-749f5d66", Component.options)
' + '  }
...
// Module
exports.push([module.i, "\n.shopcar-container[data-v-749f5d66] {\n  background-color: #eeeeee;\n  overflow: hidden;\n}\n.shopcar-container .info[data-v-749f5d66] {\n    display: flex;\n    justify-content: space-between;\n}\n.shopcar-container .info img[data-v-749f5d66] {\n      width: 60px;\n      height: 60px;\n}\n.shopcar-container .info span[data-v-749f5d66] {\n      color: red;\n}\n.shopcar-container .settle-accounts[data-v-749f5d66] {\n    display: flex;\n    justify-content: space-between;\n    align-items: center;\n}\n.shopcar-container .settle-accounts span[data-v-749f5d66] {\n      color: red;\n}\n", ""]);
...
var update = __webpack_require__(144)("7683ffb0", content, false, {});
...
var _shopcarBox = __webpack_require__(317);

var _shopcarBox2 = _interopRequireDefault(_shopcarBox);
...
exports.default = {
    ...
    methods: {
        getGoodsList: function getGoodsList() {
            ...
            this.$http.get('/goods/getShopcarList/?ids=' + ids.join()).then(function (result) {
                if (result.data.status === 0) {
                    _this.goodslist = result.data.data;
                }
            });
        },
        //将商品从store中删除
        ...
        selectedChange: function selectedChange(id, value) {
            //每当点击开关把最新的开关状态同步到store中
            this.$store.commit('updateGoodsSeleted', { id: id, selected: value });
        }
    },
    components: {
        ShopcarBox: _shopcarBox2.default
    }
};
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_bustCache_shopcar_box_vue__ = __webpack_require__(319);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_bustCache_shopcar_box_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_bustCache_shopcar_box_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_5ef4ae15_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_bustCache_shopcar_box_vue__ = __webpack_require__(320);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-5ef4ae15"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_bustCache_shopcar_box_vue___default.a,
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_5ef4ae15_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_bustCache_shopcar_box_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "src/components/subcomponents/shopcar-box.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {  return key !== "default" && key.substr(0, 2) !== "__"})) {  console.error("named exports are not supported in *.vue files.")}
...
if (true) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-5ef4ae15", Component.options)
  } else {
    hotAPI.reload("data-v-5ef4ae15", Component.options)
' + '  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(144)("28ddb6bd", content, false, {});
// Hot Module Replacement
if(true) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
if (true) {
  module.hot.accept()
  if (module.hot.data) {
    __webpack_require__(12)      .rerender("data-v-5ef4ae15", esExports)
  }
}
  ...
  return _c(
    ...
    [
      _vm._l(_vm.goodslist, function(item, index) {
        return _c("div", { key: index, staticClass: "mui-card" }, [
                  ...
                  _c("mt-switch", {
                    on: {
                      change: function($event) {
                        _vm.selectedChange(
                          item.id,
                          _vm.$store.getters.isSelected[item.id]
                        )
                      }
                    },
                    model: {
                      value: _vm.$store.getters.isSelected[item.id],
                      callback: function($$v) {
                        _vm.$set(_vm.$store.getters.isSelected, item.id, $$v)
                      },
                      expression: "$store.getters.isSelected[item.id]"
                    }
                  }),
                  _vm._v(" "),
                  _c("img", {
                    attrs: {
                      src:
                        "https://ss0.bdstatic.com/70cFuHSh_Q1YnxGkpoWK1HF6hhy/it/u=479086174,865595760&fm=200&gp=0.jpg"
                    }
                  }),
                  _vm._v(" "),
                  _c(
              ...
              [
                _c("div", [
                  ...
                  _c("p", [
                    _vm._v("已选购商品 "),
                    _c("span", [
                      _vm._v(_vm._s(_vm.$store.getters.getAllGoodsPrice.number))
                    ]),
                    _vm._v(" 件,总价 "),
                    _c("span", [
                      _vm._v(
                        "$ " +
                          _vm._s(_vm.$store.getters.getAllGoodsPrice.amount)
                      )
                    ]),
                    _vm._v("\n                            元")
                  ])
...
if (true) {
  module.hot.accept()
  if (module.hot.data) {
    __webpack_require__(12)      .rerender("data-v-749f5d66", esExports)
  }
}
